...
int rtnl_mall_add_action(struct rtnl_cls *cls, struct rtnl_act *act)
{
	struct rtnl_mall *mall;
	...
	rtnl_act_get(act);
	return rtnl_act_append(&mall->m_act, act);
}

struct rtnl_act *rtnl_mall_get_action(struct rtnl_cls *cls)
{
	struct rtnl_mall *mall;
	struct rtnl_act *act;
